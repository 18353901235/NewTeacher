...
public class ImageLoader {
	...
	private ImgBeanHolder holder = null;
	 ...
	 * @param bean
	 */
	public ImgBeanHolder loadImage(final String path,
                                   final ImageView imageView, final PicturePickBean bean) {
		// set tag
