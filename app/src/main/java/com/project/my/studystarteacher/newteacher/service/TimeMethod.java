...
public class TimeMethod {
	 ...
	 *            指定的某个时间段，以秒为单位
	 */
	public static TimeMethod timeSpanSecond(long second) {
		TimeMethod ts = new TimeMethod();
		long remain;
	 ...
	 *
	 * @param time
	 *            指定的某个时间，格式为yyyy-MM-dd HH:mm:ss
	 */
	public static TimeMethod timeSpanToNow(String time) {
		TimeMethod ts = new TimeMethod();
