...
//		System.out.println("添加表情+》》》》》》》》》》》》》》》》》》》");
        if (TextUtils.isEmpty(spannableString)) {
            return null;
        }
        Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(),
                imgId);
        bitmap = Bitmap.createScaledBitmap(bitmap, DensityUtil.dip2px(30), DensityUtil.dip2px(30), true);
    ...
    private void dealExpression(Context context,
        ...
        while (matcher.find()) {
            ...
            if (resId != 0) {
                ...
                bitmap = Bitmap.createScaledBitmap(bitmap, DensityUtil.dip2px(45), DensityUtil.dip2px(45), true);
