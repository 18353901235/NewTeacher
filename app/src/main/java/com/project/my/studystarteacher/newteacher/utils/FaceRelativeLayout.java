...
public class FaceRelativeLayout extends RelativeLayout implements
    ...
    private void onCreate() {
        imm = (InputMethodManager) MiceApplication.getInstance().getSystemService(Context.INPUT_METHOD_SERVICE);
...
//				((ImageView)v).setImageResource(R.drawable.express);
//				v.setBackground(getResources().getDrawable(R.drawable.express1));
                } else {
                    imm.hideSoftInputFromWindow(view.getWindowToken(), 0); //强制隐藏键盘
                    view.setVisibility(View.VISIBLE);
//				((ImageView)v).setImageResource(R.drawable.express1);
                }
                break;
...
//                if (view.getVisibility() == View.VISIBLE) {
//
//                    //           btn_face.setImageResource(R.mipmap.express);
//                } else {
//
//                }
                break;
