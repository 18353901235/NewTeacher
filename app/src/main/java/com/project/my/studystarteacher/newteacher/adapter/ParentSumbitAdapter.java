...
public class ParentSumbitAdapter extends CommonAdapter<String> {
    public ParentSumbitAdapter(Context context, int layoutId, List<String> datas) {
        super(context, layoutId, datas);
    }

    @Override
    protected void convert(ViewHolder viewHolder, String item, int position) {
        GridView gv = viewHolder.getView(R.id.gv);
