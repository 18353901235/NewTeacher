...
public class FileDownLoader extends BaseObject {
     ...
     */
    public FileDownLoader(Context context, String downPath, String savePath) {
        this();
    ...
    private static class EventHandler extends android.os.Handler {
        ...
        public EventHandler(FileDownLoader downLoader, Looper looper) {
            super(looper);
        ...
        public void handleMessage(Message msg) {
            BaseDownLoadListener listener = downLoader.getDownLoadListener();
            if (listener != null)
                switch (msg.what) {
                    case START:
